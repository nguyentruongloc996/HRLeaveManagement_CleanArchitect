...
namespace HRLeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20240714050123_InitialMigration")]
            ...
            modelBuilder.Entity("HRLeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 7, 14, 12, 1, 23, 4, DateTimeKind.Local).AddTicks(4231),
                            DateModified = new DateTime(2024, 7, 14, 12, 1, 23, 4, DateTimeKind.Local).AddTicks(4245),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
